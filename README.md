# mschirrmeister/corelocationcli

CorelocationCLI build as universal binary on macOS Big Sur.

## How do I install a formula?

```sh
brew tap mschirrmeister/corelocationcli
...
```sh
brew install mschirrmeister/corelocationcli/<formula>
```
